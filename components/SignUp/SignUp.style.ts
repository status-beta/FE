...
import { FlexAlignBox, FlexCenterBox, FlexColumnBox } from '@/shared/flex';
...
export const AuthBtn = styled.button<{ $isValid?: string }>`
  position: absolute;
  right: 3px;
  min-width: 5.5rem;
...
export const Emailinput = styled.input<{ $_border: string }>`
  width: 100%;
  padding: 0.8rem;
...
export const Join = styled.button<{ $isValid: boolean }>`
  width: 100%;
  height: 43px;
  margin-top: 10%;
