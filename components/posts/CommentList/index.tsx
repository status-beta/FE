...
import CommentPostSvg from '@/public/assets/svg/CommentPostSvg';
// import { handleImgError } from '@/utils/handleImgError';
// import { readGroupUser } from '@/apis/groupUserApi';
import { CommentForm, CommentFormUserImg, CommentInput, CommentSubmit, List, More } from './styles';
...
function CommentList({ groupId, postId, setCommentCount, detailMode = false }: CommentListProps) {
