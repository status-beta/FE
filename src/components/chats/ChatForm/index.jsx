...
import { Button, ButtonContainer, Buttons, FormContainer, TextArea, Wrapper } from './styles';

const ChatForm = ({ setChats, groupUserId, roomId, groupId, otherUserId, scrollRef }) => {
  ...
  const onSubmit = useCallback(
    ...
    [groupUserId, roomId, textareaRef, socket, addChatFn, groupId, otherUserId, setChats, scrollRef],
  );
